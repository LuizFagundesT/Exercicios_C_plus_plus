...
int main()
{
    int n1,n2,n3,result;
    char op;
  //fazendo o verficador de opção digitada pelo usuário
    do
    {
      printf("PARAMETRO A: MEDIA DAS NOTAS\nPARAMETRO B: MEDIA ARITIMEDICA\nDIGITE O PARAMETRO DA NOTA A ou B:");
      scanf("%c",&op);
    ...
    }else
    {
        ...
        printf("A MEDIA ARITIMEDICA DAS NOTAS EH : %d",result);
